function [sensorCellSpeedArray, sensorCellTravelTimesArray,indexArray,linkIdArray]=setCellDataSensor(numberOfCells,network,sensorIdArray,totalNumberOfCells,numberOfTimeSteps,numberOfSensors,linkIdArray,cellSize,sensorSpeedArray)
